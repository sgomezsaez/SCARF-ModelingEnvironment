...
$( document ).ready(function() {
	...
	$("#nameDistribution").val(nameDistribution);
...
<div class="hidden" id="skelettonForWorkload">
	<%-- create property value holders for each capability type; used for NEWLY created capability --%>
	 ...
	 <input type="hidden" id="workloadHidden" />
</div>
...
<div class="hidden" id="skelettonForPerformance">
	<%-- create property value holders for each capability type; used for NEWLY created capability --%>
	 ...
	 <input type="hidden" id="performanceHidden" />
</div>
<input type="hidden" id="nameDistribution" />
<input type="hidden" id="newAlphaIDHidden" />
...
function redirectAdapt(urlTemplateAlpha, urlTemplateGamma ){
	...
	var performanceSet=$("#performanceHidden").val();
	//ID of the alpha topology
	var alphaIDPertos=$("#newAlphaIDHidden").val();

	//Creating a form that submits the app characteristics to the refinement page
    ...
    hiddenField7.setAttribute("name", "workloadGiven");
    hiddenField7.setAttribute("value", workloadSet);
    
    //Adding the attribute to a field
    var hiddenField8 = document.createElement("input");
    hiddenField8.setAttribute("type", "hidden");
    hiddenField8.setAttribute("name", "performanceGiven");
    hiddenField8.setAttribute("value", performanceSet);
    
    //Adding the ID given by pertos, used if you save the knowledge to the CB
    var hiddenField9 = document.createElement("input");
    hiddenField9.setAttribute("type", "hidden");
    hiddenField9.setAttribute("name", "idGiven");
    hiddenField9.setAttribute("value", alphaIDPertos);
